...
#define USART_PIN_VALUE           (IOCON_MODE_PULLUP | IOCON_HYS_ENABLE)
  ...
  #define UART0_PCLKSEL0_POS   (6)
  #define UART1_PCLKSEL0_POS   (8)
  #define UART2_PCLKSEL1_POS   (16)
  #define UART3_PCLKSEL1_POS   (18)
#endif
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_cts->Portnum, usart->pins.pin_cts->Pinnum, usart->pins.func_cts, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_rts->Portnum, usart->pins.pin_rts->Pinnum, usart->pins.func_rts, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dcd->Portnum, usart->pins.pin_dcd->Pinnum, usart->pins.func_dcd, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dsr->Portnum, usart->pins.pin_dsr->Pinnum, usart->pins.func_dsr, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dtr->Portnum, usart->pins.pin_dtr->Pinnum, usart->pins.func_dtr, 0, 0);  
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_ri->Portnum, usart->pins.pin_ri->Pinnum, usart->pins.func_ri, 0, 0);  
#elif defined (LPC177x_8x)
...
static int32_t USART_Uninitialize (USART_RESOURCES *usart) {
  ...
  PIN_Configure (usart->pins.pin_tx->Portnum, usart->pins.pin_tx->Pinnum, 0, 0, 0);
  
  // Reset RX pin configuration
  PIN_Configure (usart->pins.pin_rx->Portnum, usart->pins.pin_rx->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  // Reset TX pin configuration
  ...
  if (usart->capabilities.cts) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_cts->Portnum, usart->pins.pin_cts->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (usart->capabilities.rts) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_rts->Portnum, usart->pins.pin_rts->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (usart->capabilities.dcd) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dcd->Portnum, usart->pins.pin_dcd->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (usart->capabilities.dsr) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dsr->Portnum, usart->pins.pin_dsr->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (usart->capabilities.dtr) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_dtr->Portnum, usart->pins.pin_dtr->Pinnum, 0, 0, 0);  
#elif defined (LPC177x_8x)
  ...
  if (usart->capabilities.ri) {
#if defined (LPC175x_6x)
    PIN_Configure (usart->pins.pin_ri->Portnum, usart->pins.pin_ri->Pinnum, 0, 0, 0);  
#elif defined (LPC177x_8x)
...
static int32_t USART_PowerControl (ARM_POWER_STATE  state,
  ...
  switch (state) {
    case ARM_POWER_OFF:
      ...
      // FIFO Reset
      usart->reg->FCR = USART_FCR_RXFIFORES | USART_FCR_TXFIFORES;
